    ...
    return (
        <>
            <div className="container">
                <div className="authentication-wrapper authentication-basic container-p-y" style={{ minHeight: "100vh", display: "flex", alignItems: "center" }}>
                    <div className="authentication-inner" style={{ maxWidth: "400px", margin: "0 auto" }}>
                        {/* Register */}
                        <div className="card">
                            <div className="card-body p-5">
                                ...
                                <div className="app-brand justify-content-center">
                                    <a href="index.html" className="app-brand-link gap-2">
                                        ...
                                        <span className="app-brand-text demo text-body fw-bolder">Smp</span>
                                    </a>
                                </div>
                                {/* /Logo */}
                                <h4 className="my-4">Welcome to 👋<br /> Student Management Portal! </h4>
                                <p className="mb-4">Please sign-in to your account and start the management</p>
