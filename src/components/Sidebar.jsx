...
const Sidebar = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <>
            {/* Menu */}
            <aside id="layout-menu" className={`layout-menu menu-vertical menu bg-menu-theme ${isOpen ? "show" : ""}`}>
                <div className="app-brand demo">
                    <NavLink to="/dashboard" className="app-brand-link">
                        ...
                        <span className="app-brand-text demo menu-text fw-bolder ms-2">SMP</span>
                    </NavLink>
                ...
                <ul className="menu-inner py-1">
                    ...
                    {/* Forms */}
                    <li className="menu-item">
                        <NavLink to="/dashboard/addstudent" className="menu-link">
                            <i className="menu-icon tf-icons bx bx-detail" />
                            <div data-i18n="Horizontal Form">Add Student</div>
                        </NavLink>
                    </li>
                    <li className="menu-item">
                        <NavLink to="/dashboard/takeattendance" className="menu-link">
                            <i className="menu-icon tf-icons bx bx-detail" />
                    ...
                    <li className="menu-item">
                        <NavLink to="/dashboard/viewstudent" className="menu-link">
                            ...
                            <div data-i18n="Tables">View Students</div>
                        </NavLink>
                    </li>
                    <li className="menu-item">
